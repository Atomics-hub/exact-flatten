...
const consumer = await mkdtemp(join(tmpdir(), 'exact-flatten-consumer-'));
...
import * as esm from 'exact-flatten';
import {createRequire} from 'node:module';
import {runChecks} from './checks.mjs';
const cjs = createRequire(import.meta.url)('exact-flatten');
assert.deepEqual(Object.keys(cjs).sort(), ['FlattenError', 'flatten', 'unflatten']);
